  ...
  return (
    <DashboardLayout pageTitle={`Audit: ${member.name}`}>
      <div className="space-y-6 pb-20 animate-fade-in max-w-[1600px] mx-auto">
        ...
        <div className="bg-[#131241] rounded-[32px] p-8 border border-white/5 shadow-2xl relative overflow-hidden">
           ...
           <div className="flex flex-col xl:flex-row items-center justify-between gap-8 relative z-10">
              ...
              <div className="flex items-center gap-6">
                 <button onClick={() => router.back()} className="p-4 bg-white/5 hover:bg-white/10 rounded-2xl text-white transition-all group active:scale-95">
                    <svg className="group-hover:-translate-x-1 transition-transform" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3"><polyline points="15 18 9 12 15 6"></polyline></svg>
                 </button>
                 <div className="flex items-center gap-5">
                    <div className="w-20 h-20 rounded-[24px] bg-gradient-to-br from-[#10b981] to-[#059669] flex items-center justify-center text-3xl font-black text-white shadow-xl uppercase">
                    ...
                    <div>
                       ...
                       <div className="flex items-center gap-3 mt-2">
                          <span className="text-sm font-black text-[#10b981] tracking-widest uppercase">ID: {member.memberId}</span>
                          <span className="w-1 h-1 rounded-full bg-white/20" />
                          <span className="text-[11px] font-bold text-white/40 uppercase tracking-[0.2em]">{member.role}</span>
                       </div>
                    </div>
                 </div>
              </div>
                 ...
                 <div className="flex bg-black/40 p-1.5 rounded-[20px] border border-white/5 backdrop-blur-md">
                    {(['OVERVIEW', 'KYC', 'NETWORK'] as const).map(tab => (
                      <button
                        ...
                        className={`px-8 py-3 rounded-[14px] text-[10px] font-black uppercase tracking-[0.2em] transition-all duration-300 ${
        ...
        {activeTab === 'OVERVIEW' && (
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
             ...
             <div className="lg:col-span-8 space-y-6">
                <div className="bg-[#131241] rounded-[32px] p-10 border border-white/5 shadow-2xl overflow-hidden relative">
                   <div className="absolute top-0 left-0 w-1.5 h-full bg-[#10b981]" />
                   <h3 className="text-xs font-black text-white/30 uppercase tracking-[0.4em] mb-12 flex items-center gap-4">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                   ...
                   <MiniStat label="Recruits" value={member.personalRecruitsThisMonth || 0} icon="user-plus" color="emerald" sub="This Month" />
             ...
             <div className="lg:col-span-4 space-y-6">
                <div className="bg-[#131241] rounded-[32px] p-10 border border-white/5 shadow-2xl relative overflow-hidden group">
        ...
        {activeTab === 'KYC' && (
          <div className="space-y-6 animate-slide-up">
             <div className="bg-[#131241] rounded-[40px] p-12 border border-white/5 shadow-2xl">
        ...
        {activeTab === 'NETWORK' && (
          <div className="bg-[#131241] rounded-[40px] p-16 border border-white/5 shadow-2xl text-center">
