    ...
    <DashboardLayout pageTitle="Regional Network">
      <div className="space-y-6 pb-20">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
           <div>
             <p className="text-[10px] font-black text-[#10b981] uppercase tracking-widest mb-1">CUREBHARAT / SH / NETWORK</p>
           ...
           <div className="flex gap-4 w-full md:w-auto items-center">
              <div className="relative flex-1 md:flex-none">
                ...
                <input 
                  ...
                  className="bg-[#131241] border border-white/5 rounded-xl pl-10 pr-4 py-2.5 text-xs text-white outline-none focus:border-[#10b981]/30 w-full md:w-64 transition-all"
                />
              </div>
              <ExportDropdown 
                title="Regional Network Report"
                headers={['Member ID', 'Name', 'Role', 'Status', 'Joined']}
                  ...
                  filteredMembers.map((member) => (
                    <tr key={member._id} className="hover:bg-white/1 transition-colors">
                      <td className="px-6 py-6">
                        <span className="text-xs font-mono font-bold text-[#10b981]">{member.memberId}</span>
                      </td>
                      <td className="px-6 py-6">
                      ...
                      <td className="px-6 py-6 text-right">
                        <button className="text-[10px] font-bold text-[#10b981] hover:text-white transition-colors uppercase tracking-widest bg-white/5 px-4 py-2 rounded-lg border border-white/5">View Profile</button>
                      </td>
                    </tr>
                  ))
                )}
