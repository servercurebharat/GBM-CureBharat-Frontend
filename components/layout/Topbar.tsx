      ...
      <div className="hidden sm:flex flex-1 justify-end px-8">
        <div className="relative w-full max-w-md">
          ...
          <input 
            ...
            className="w-full bg-white/5 border border-white/10 rounded-xl pl-10 pr-4 py-2 text-sm text-white font-medium placeholder:text-white/20 focus:outline-none focus:ring-2 focus:ring-admin/50 transition-shadow"
          />
        </div>
      </div>
